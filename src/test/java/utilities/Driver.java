        ...
        if (driver == null) {
            ...
            switch (ConfigReader.getProperty("platformName")) {
                case "Android":
                    ...
                    options.setAppPackage("com.inomera.sm");  //Uygulama paketi adini ayarlar
                    options.setAppActivity("com.inomera.sm.ui.home.HomeActivity"); //Uygulama aktivite adini ayarla
