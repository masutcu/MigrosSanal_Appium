...
import static utilities.Swipe.SwipeDirection.SWIPE_LEFT;
import static utilities.Swipe.SwipeDirection.SWIPE_RIGHT;
...
public class Swipe {
    ...
    public void swipe(SwipeDirection direction) {
        ...
        if (driver instanceof AndroidDriver) {
            ele = driver.findElement(AppiumBy.xpath(String.valueOf(TestElement.ANDROID_GEN_LOCATOR)));
        } else if (driver instanceof IOSDriver && (direction == SWIPE_RIGHT || direction == SWIPE_LEFT)) {
            ele = driver.findElement(AppiumBy.xpath(String.valueOf(TestElement.IOS_GEN_LOCATOR_02)));
        } else {
            ele = driver.findElement(AppiumBy.accessibilityId(String.valueOf(TestElement.IOS_GEN_LOCATOR)));
        }
    ...
    public void swipeLeftMultipleTimes(WebElement ele, int times) {
